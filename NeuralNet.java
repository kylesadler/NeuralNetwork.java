 ...
 * 
 * <li>NeuralNet is double[] input to double[] output (manipulate your data to be 1 dimension)</li>
 * 
 * <li>The train(), test(), and predict() methods take double[][] arguments which
 * are arrays of double[] input and output data</li>
 * 
 * <li>Use checkData() on input and output data before using NeuralNet to ensure
...
public class NeuralNet{
    ...
    //constructors
    /**
     * Creates NeuralNet with structure array s and learning rate of 1.
     * 
     * @param s structure of NeuralNet represented as array of the form {# nodes layer 1, # nodes layer 2, ...}
     */ 
    public NeuralNet(int[] s){
        rand = new Random();
        learningRate = 1;
        biasLearningRate = 1;
    ...
    /**
     * Creates NeuralNet with structure array s and learning rate lr.
     * 
     * @param s structure of NeuralNet represented as array of the form {# nodes layer 1, # nodes layer 2, ...}
     * 
     * @param lr network learning rate
     */ 
    public NeuralNet(int[] s, double lr){
        rand = new Random();
        learningRate = lr;
        biasLearningRate = lr;
    ...
    /**
     * Creates NeuralNet with structure array s, learning rate lr, and Random seed.
     * 
     * @param s structure of NeuralNet represented as array of the form {# nodes layer 1, # nodes layer 2, ...}
     * 
     * @param lr network learning rate
     * 
     * @param seed seed for random starting weights and biases of NeuralNet 
     */ 
    public NeuralNet(int[] s, double lr, long seed){
     ...
     * @param predictingInput input to use for NeuralNet predictions
     */ 
